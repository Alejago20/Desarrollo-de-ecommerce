    ...
    <div className="grid grid-cols-2 gap-8 mt-6 mb-16 lg:grid-cols-4 lg:gap-5">
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="space-y-1">
          <p className="font-semilbold">Envios gratis</p>
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="space-y-1">
          <p className="font-semilbold">Devoluciones</p>
          <p className="text-sm">Devuelve el equipo si no te satisface la compra dentro de
          72 horas</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="space-y-1">
          <p className="font-semilbold">Soporte 24/7</p>
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="space-y-1">
          <p className="font-semilbold">Garantia</p>
