...
interface Props {
    ...
    // AL EDITARLO PUEDE QUE LE MANDEMOS LA DESCRIPCION
...
useEffect(() => {
	//poder mostrar cuando se carga la informacion del producto tambine cargar la informacion de la descripcion
