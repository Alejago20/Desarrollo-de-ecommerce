...
export const FromProduct = ({ titleForm }: Props) => {
  //Vamos a definir el formulario
  const {
    register,
    handleSubmit,
    formState: { errors },
...
const {mutate:updateProduct,isPending:isUpdatePending}=useUpdatePrduct(product?.id || '')
const{mutate:createProduct,isPending}=useCreatorProduct();
  ...
  // React hook form tiene algo que nos permite manipular el nombre en momento que un usuario escribe
 // se llama watch
// le pasamos el campo que queremos observar o estar pendiente de los cambios en el momento que el usuario escriba
const watchName = watch('name');
  ...
  return (
    <div className="flex flex-col gap-6 relative">
      ...
      <SectionFormProduct titleSection="Detalles de producto" className="lg:col-span-2 lg:row-span-2">
	  ...
	  <SectionFormProduct>
        ...
        <SectionFormProduct
				...
				<SectionFormProduct titleSection="Descripcion del producto "
