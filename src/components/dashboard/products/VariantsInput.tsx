...
export const VariantsInput = ({
    ...
    // cada vez que cambien los field va ejecutar el efecto
    // es decir los campos van a  cambiar cada vez que agreguemos un nuevo campo, una nueva variante ahi va a cambiar
	useEffect(() => {
		setColorActive(prev =>
