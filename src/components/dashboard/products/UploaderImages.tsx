...
//cada vez que cargamos un nuevo archivo lo detecte el ochange
...
const handleImageChange = (
  ...
  const handleRemoveImages = (index: number) => {
    //obtener las imagenes actualizadas o nuevas
  ...
  return (
   <>
  {/*  que acepte cualquier tipo de imagen y tambien multiple es que acepte mas de una imagen*/}
   <input 
   type="file" 
accept="image/*"
   multiple
   ...
   />
  {/*  va renderizar las imagenes que se van cargando */}
