...
export const createOrder=async (order:OrderInput) => {
    ...
    .from('customers')       // Seleccionamos la tabla 'customers'
    .select('id')           // Pedimos solo la columna 'id'
    .eq('user_id', userId)  // Filtramos donde 'user_id' sea igual a 'userId'
    .single();              // Asegura que solo se obtenga un único registro
...
// obtener las ordenes de un determinado cliente
